...
- [Steering Claude Code: skills, hooks, rules, subagents, and more](https://claude.com/blog/steering-claude-code-skills-hooks-rules-subagents-and-more) — Anthropic, claude.com blog. The core split, mechanism guidance, and anti-patterns are drawn from it; the decision-tree ordering and the building-enforcement and pattern sections are local adaptations. Where the article and the doc anchors below disagree, the docs win.
